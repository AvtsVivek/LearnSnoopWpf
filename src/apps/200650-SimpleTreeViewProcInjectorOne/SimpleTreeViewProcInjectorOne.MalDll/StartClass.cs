...
using SimpleTreeViewProcInjectorOne.MalDll.Windows;
using System.IO;
...
namespace SimpleTreeViewProcInjectorOne.MalDll
{
    public class StartClass
    {
        public static int StartMethod(string settingsData)
        {
            var dllPathToload = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)!, "SimpleTreeViewProcInjectorOne.Core.dll");
