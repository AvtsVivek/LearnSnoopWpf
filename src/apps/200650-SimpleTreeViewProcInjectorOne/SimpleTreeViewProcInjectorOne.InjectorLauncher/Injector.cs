...
public static class Injector
{
    public static void LogMessage(string message, bool append = true)
    {
        ...
        var pathName = Path.Combine(applicationDataPath, "SimpleTreeViewProcInjectorOneLog.txt");
    ...
    {
        StartSimpleTreeViewProcInjectorOne(processWrapper, injectorData);
    }
    ...
    private static void StartSimpleTreeViewProcInjectorOne(ProcessWrapper processWrapper, InjectorData injectorData)
    {
        var injectorDllName = $"SimpleTreeViewProcInjectorOne.CppInjectorCore.{processWrapper.Architecture}.dll";
