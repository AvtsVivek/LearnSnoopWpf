namespace BasicProcInjector.WpfInjectorHost.Utilities
{
    ...
    [Serializable]
    public class EventTrackerSettingsItemNew
    {
        // just for serialization
        private EventTrackerSettingsItemNew()
        {
            this.Id = string.Empty;
        }

        public EventTrackerSettingsItemNew(string id)
        {
            this.Id = id;
        }
    ...
    /// </summary>
    [DebuggerDisplay("{" + nameof(Id) + "}")]
    public class EventTrackerNew : INotifyPropertyChanged, IComparable, IDisposable
    {
        public EventTrackerNew(Type targetType, RoutedEvent routedEvent)
        {
            ...
            set
            {
                if (this.isEnabled != value)
                {
                        ...
                        && this.everEnabled == false)
                    {
                        ...
                        this.eventRegistration = EventManagerWrapperNew.Instance.RegisterClassHandler(Dispatcher.CurrentDispatcher, this.targetType, this.RoutedEvent, this.HandleEvent, true);
                    }
...
#pragma warning restore WPF0107 // Backing member for a RoutedEvent should be static and readonly.
        ...
        private EventManagerWrapperNew.EventRegistrationNew? eventRegistration;

        #region IComparable Members
        public int CompareTo(object? obj)
        {
            var otherTracker = obj as EventTrackerNew;
        ...
        public void Dispose()
        {
            ...
            {
                EventManagerWrapperNew.Instance.RemoveClassHandler(this.eventRegistration);
            }
