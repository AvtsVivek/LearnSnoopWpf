namespace BasicProcInjector.WpfInjectorHost.Utilities
{
    ...
    [Serializable]
    public class PropertyFilterSetNew : INotifyPropertyChanged
    {
        ...
        public bool IsPropertyInFilter(PropertyInformationNew property)
        {
        ...
        public PropertyFilterSetNew Clone()
        {
            var src = this;
            return new PropertyFilterSetNew
            {
