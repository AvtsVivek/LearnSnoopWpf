...
//    public partial class BindingDiagnosticHelperNew
//    {
//        private readonly ObservableCollection<FailedBindingNew> failedBindings = new();

//        public ReadOnlyObservableCollection<FailedBindingNew> FailedBindings { get; private set; } = null!;
...
//            if (ReflectionHelperNew.TryGetField(typeof(VisualDiagnostics), "s_IsEnabled", out var value)
//                && value is bool and true)
//            {


//                if (ReflectionHelperNew.TrySetProperty(typeof(BindingDiagnostics), "IsEnabled", true))
//                {
//                    this.IsActive = true;
...
//                    PresentationTraceSourcesHelperNew.RefreshAndEnsureRequiredLevel(forceRefresh: true);
//                }
//            }
//        }
...
//                failedBinding = new FailedBindingNew(weakReference);
//                this.failedBindings.Add(failedBinding);
//            }

//            {
//                failedBinding.AddFailedBindingDetail(new FailedBindingDetailNew(failedBinding, e.EventType, e.Code, e.Message));
//            }
//        }
...
//    [PublicAPI]
//    public class FailedBindingNew
//    {
//        private readonly ObservableCollection<FailedBindingDetailNew> failedBindingDetails;
//        private string? messages;

//        public FailedBindingNew(WeakReference<BindingExpressionBase> bindingExpressionBase)
//        {
//            this.BindingExpressionBase = bindingExpressionBase;
//            this.failedBindingDetails = new ObservableCollection<FailedBindingDetailNew>();
//            this.FailedBindingDetails = new ReadOnlyObservableCollection<FailedBindingDetailNew>(this.failedBindingDetails);
//        }

//        public WeakReference<BindingExpressionBase> BindingExpressionBase { get; }

//        public ReadOnlyObservableCollection<FailedBindingDetailNew> FailedBindingDetails { get; }

//        public void AddFailedBindingDetail(FailedBindingDetailNew failedBindingDetail)
//        {
//            this.messages = null;
...
//    [PublicAPI]
//    public class FailedBindingDetailNew
//    {
//        public FailedBindingDetailNew(FailedBindingNew failedBinding, TraceEventType eventType, int code, string message, params object[]? parameters)
//        {
...
//        public FailedBindingNew FailedBinding { get; }
