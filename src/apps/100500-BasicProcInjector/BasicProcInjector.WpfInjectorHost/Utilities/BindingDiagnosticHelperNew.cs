namespace BasicProcInjector.WpfInjectorHost.Utilities
{
    ...
    public partial class BindingDiagnosticHelperNew : ICacheManagedNew
    {
        public static readonly BindingDiagnosticHelperNew Instance = new();

        private BindingDiagnosticHelperNew()
        {
        ...
        public void TrySetBindingError(BindingExpressionBase bindingExpressionBase, DependencyObject dependencyObject, DependencyProperty dependencyProperty, Action<string> errorSetter)
        {
            ...
            var scopeGuard = new ScopeGuardNew(
                () =>
                {
                    PresentationTraceSourcesHelperNew.EnsureRequiredLevel();
