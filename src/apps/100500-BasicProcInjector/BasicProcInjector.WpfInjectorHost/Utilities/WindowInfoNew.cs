    ...
    public class WindowInfoNew
    {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (this.isValidProcess == false)
                        {
                            ...
                            foreach (var module in NativeMethodsNew.GetModulesFromWindowHandle(this.HWnd))
                            {
        ...
        public int OwningProcessId
        {
            get
            {
                ...
                {
                    NativeMethodsNew.GetWindowThreadProcessId(this.HWnd, out var processId);
        ...
        public ProcessInfoNew? OwningProcessInfo
        {
            get
            {
        ...
        public string WindowTitle
        {
            get
            {
                var windowTitle = NativeMethodsNew.GetText(this.HWnd);
        ...
        public string ClassName => NativeMethodsNew.GetClassName(this.HWnd);
