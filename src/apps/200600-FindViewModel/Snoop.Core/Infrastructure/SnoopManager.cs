...
public class SnoopManager
{
    ...
    private static SnoopMainBaseWindow CreateSnoopWindow(TransientSettingsData settingsData, DispatcherRootObjectPair dispatcherRootObjectPair, Func<SnoopMainBaseWindow> instanceCreator)
    {
        ...
        DrillDown(dispatcherRootObjectPair.RootObject);
    ...
    private static void DrillDown(object rootObject)
    {
        if (rootObject == null)
        {
            return;
        ...
        if (rootObject is Application application)
        {
            ...
            if (mainWindow != null)
            {
                LogHelper.WriteLine("Drilling down into Application.MainWindow.");
