namespace FindViewModel.Core
{
    ...
    public sealed class TransientSettingsData
    {
        ...
        public FindViewModelStartTargetNew StartTarget { get; set; } = FindViewModelStartTargetNew.SnoopUI;
        ...
        public string? FindViewModelInstallPath { get; set; } = Environment.GetEnvironmentVariable(SettingsHelper.SNOOP_INSTALL_PATH_ENV_VAR);
        ...
        public static TransientSettingsData LoadCurrent(string settingsFile)
        {
            ...
            Environment.SetEnvironmentVariable(SettingsHelper.SNOOP_INSTALL_PATH_ENV_VAR, Current.FindViewModelInstallPath, EnvironmentVariableTarget.Process);
    ...
    // [PublicAPI]
    public enum FindViewModelStartTargetNew
    {
        SnoopUI = 0,
        Zoomer = 1
    }
