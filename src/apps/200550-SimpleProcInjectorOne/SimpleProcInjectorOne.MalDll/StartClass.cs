...
using SimpleProcInjectorOne.MalDll.Infrastructure;
using SimpleProcInjectorOne.MalDll.Windows;
using System.IO;
...
namespace SimpleProcInjectorOne.MalDll
{
    public class StartClass
    {
        public static int StartMethod(string settingsData)
        {
            var dllPathToload = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)!, "SimpleProcInjectorOne.Core.dll");
