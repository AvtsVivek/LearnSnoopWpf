namespace SimpleProcInjectorOne.InjectorLauncher;

using SimpleProcInjectorOne.Core;
using System;
...
public static class Injector
{
    public static void LogMessage(string message, bool append = true)
    {
        ...
        var pathName = Path.Combine(applicationDataPath, "SimpleProcInjectorOneLog.txt");
    ...
    {
        StartSimpleProcInjectorOne(processWrapper, injectorData);
    }
    ...
    private static void StartSimpleProcInjectorOne(ProcessWrapper processWrapper, InjectorData injectorData)
    {
        var injectorDllName = $"SimpleProcInjectorOne.CppInjectorCore.{processWrapper.Architecture}.dll";
