namespace PresentationSourceWinFormsOne.InjectorLauncher;
...
public static class Injector
{
    ...
    {
        var injectorDllName = $"PresentationSourceWinFormsOne.CppInjectorCore.{processWrapper.Architecture}.dll";
