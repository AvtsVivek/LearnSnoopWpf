...
namespace PresentationSourceWinFormsOne.MalDll.Windows
{
    public class SnoopBaseWindow : Window
    {
        ...
        {
            {
                var resourceDictionary = (ResourceDictionary)System.Windows.Application.LoadComponent(new Uri("/Snoop.Core;component/Icons.xaml", UriKind.Relative));
                Debug.Assert(resourceDictionary is not null, "Icons could not be loaded.");
                this.Resources.MergedDictionaries.Add(resourceDictionary);
            }
            
            {
                //var resourceDictionary = (ResourceDictionary)System.Windows.Application.LoadComponent(new Uri("/Snoop.Core;component/Styles.xaml", UriKind.Relative));
