...
using PresentationSourceWinFormsOne.MalDll.Infrastructure;
using PresentationSourceWinFormsOne.MalDll.Windows;
...
namespace PresentationSourceWinFormsOne.MalDll
{
    [Serializable]
    ...
    public class StartClass
    {
        public static int StartMethod(string settingsFile)
        {
            ...
            var dllPathToload = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)!, "PresentationSourceWinFormsOne.Core.dll");
