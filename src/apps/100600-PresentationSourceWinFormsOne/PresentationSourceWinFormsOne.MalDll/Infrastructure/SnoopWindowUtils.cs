...
namespace PresentationSourceWinFormsOne.MalDll.Infrastructure
{
        ...
        public static void LoadWindowPlacement(Window window, WINDOWPLACEMENT? windowPlacement)
        {
            ...
            try
            {
                         ...
                         && IsVisibleOnAnyScreen(windowPlacementValue.NormalPosition, out var screen))
                {
                    ...
                    var logicalScreenPosition = DPIHelper.DevicePixelsToLogical(new System.Windows.Point(windowPlacement.Value.NormalPosition.Left, windowPlacement.Value.NormalPosition.Top), hwnd);
                    ...
                    var logicalWindowSize = DPIHelper.DevicePixelsToLogical(new System.Windows.Point(windowPlacement.Value.NormalPosition.Width, windowPlacement.Value.NormalPosition.Height), hwnd);
                    var logicalScreenSize = DPIHelper.DevicePixelsToLogical(new System.Windows.Point(screen.Bounds.Width, screen.Bounds.Height), hwnd);
