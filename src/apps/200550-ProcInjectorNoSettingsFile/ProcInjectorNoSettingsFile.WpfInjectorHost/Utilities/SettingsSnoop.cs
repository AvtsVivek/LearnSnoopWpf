namespace ProcInjectorNoSettingsFile.WpfInjectorHost.Utilities
{
    ...
    public sealed class SettingsSnoop : SettingsBase<SettingsSnoop>
    {
        ...
        {
            this.SettingsFile = SettingsHelper.GetSettingsFileForProcInjectorNoSettingsFile();
        }
        ...
        public MultipleAppDomainModeNew MultipleAppDomainMode
        {
        ...
        public MultipleDispatcherModeNew MultipleDispatcherMode
        {
