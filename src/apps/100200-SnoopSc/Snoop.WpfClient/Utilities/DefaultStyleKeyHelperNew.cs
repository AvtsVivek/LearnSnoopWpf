namespace Snoop.WpfClient.Utilities
{
    ...
    public class DefaultStyleKeyHelperNew : FrameworkElement
    {
...
#pragma warning disable WPF0016
    public class DefaultStyleKeyFixerNew : DependencyObject
    {
        public static readonly DependencyProperty KeyFixerProperty = DependencyProperty.RegisterAttached(
            "KeyFixer", typeof(object), typeof(DefaultStyleKeyFixerNew), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, OnKeyFixerChanged));
        ...
        {
            var defaultStyleKey = DefaultStyleKeyHelperNew.GetDefaultStyleKey(d);
            ...
            DefaultStyleKeyHelperNew.SetDefaultStyleKey(d, dpoType);
        }
        ...
        private static void ControlLoaded(object sender, RoutedEventArgs e)
        {
            ...
            var defaultStyleKey = DefaultStyleKeyHelperNew.GetDefaultStyleKey(dpo);
