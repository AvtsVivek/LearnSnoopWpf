namespace Snoop.WpfClient.Utilities
{
    ...
    public class PropertyFilterNew : INotifyPropertyChanged
    {
        ...
        private static readonly List<string> uncommonPropertyNames = new()
    {
        ...
        public PropertyFilterNew(string filterString, bool showDefaults)
        {
        ...
        public PropertyFilterSetNew? SelectedFilterSet { get; set; }
        ...
        public bool ShouldShow(PropertyInformationNew property)
        {
        ...
        private bool ShouldShowDefaultValueFilter(PropertyInformationNew property)
        {
        ...
        private static bool IsUncommonProperty(PropertyInformationNew property)
        {
        ...
        private abstract class MatcherBase
        {
            ...
            public bool Matches(PropertyInformationNew propertyInformation)
            {
