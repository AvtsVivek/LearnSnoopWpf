namespace Snoop.WpfClient.Utilities
{
    ...
    [ComImport]
    [Guid("85812C00-2593-400A-9DBA-A310ADA231F1")]
    [TypeLibType(2)]
#pragma warning disable CS0618
    [ClassInterface(ClassInterfaceType.AutoDual)]
#pragma warning restore CS0618
    public class CorRuntimeHostClassNew : ICorRuntimeHostNew, CorRuntimeHostNew,
        IGCHostNew, ICorConfigurationNew, IValidatorNew, IDebuggerInfoNew
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        public virtual extern void GetConfiguration([MarshalAs(UnmanagedType.Interface)] out ICorConfigurationNew pConfiguration);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        public virtual extern void GetThreadStats([In] ref uint pFiberCookie, [In][Out] ref _COR_GC_THREAD_STATS_NEW pStats);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        public virtual extern void FormatEventInfo([In][MarshalAs(UnmanagedType.Error)] int hVECode, [In] tag_VerErrorNew Context, [In] [Out] [MarshalAs(UnmanagedType.LPWStr)]
