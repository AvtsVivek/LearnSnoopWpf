namespace Snoop.WpfClient.Utilities
{
    ...
    public class SnoopBaseWindowNew : Window
    {
        public SnoopBaseWindowNew()
        {
            ...
            SnoopPartsRegistryNew.AddSnoopVisualTreeRoot(this);

            this.SetValue(DefaultStyleKeyFixerNew.KeyFixerProperty, new object());
        }
        ...
        protected override void OnInitialized(EventArgs e)
        {
            ...
            ThemeManagerNew.Current.ApplyTheme(SettingsCoreNew.Default.ThemeMode, this);
        ...
        {
            SnoopPartsRegistryNew.RemoveSnoopVisualTreeRoot(this);
