namespace Snoop.WpfClient.Utilities
{
    ...
    public class ThemeManagerNew
    {
        ...
        public void ApplyTheme(ThemeModeNew themeMode)
        {
            foreach (var visual in SnoopPartsRegistryNew.GetSnoopVisualTreeRoots())
            {
                this.ApplyTheme(themeMode, visual);
            }
        }

        public void ApplyTheme(ThemeModeNew themeMode, Visual visual)
        {
            ...
            var finalThemeMode = themeMode is ThemeModeNew.Auto
                ? AppsUseLightTheme() ? ThemeModeNew.Light : ThemeModeNew.Dark
                : themeMode;

            var resourceDictionary = finalThemeMode is ThemeModeNew.Dark
                ? this.darkResourceDictionary
                : this.lightResourceDictionary;

            var resourceDictionaryToRemove = finalThemeMode is ThemeModeNew.Dark
                ? this.lightResourceDictionary
                : this.darkResourceDictionary;
