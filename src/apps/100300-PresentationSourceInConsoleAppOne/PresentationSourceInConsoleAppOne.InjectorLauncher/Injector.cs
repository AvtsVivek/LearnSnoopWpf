namespace PresentationSourceInConsoleAppOne.InjectorLauncher;
...
public static class Injector
{
    ...
    {
        var injectorDllName = $"PresentationSourceInConsoleAppOne.CppInjectorCore.{processWrapper.Architecture}.dll";
