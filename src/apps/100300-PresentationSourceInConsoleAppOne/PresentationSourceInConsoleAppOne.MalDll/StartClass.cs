...
using PresentationSourceInConsoleAppOne.MalDll.Infrastructure;
using PresentationSourceInConsoleAppOne.MalDll.Windows;
...
namespace PresentationSourceInConsoleAppOne.MalDll
{
    [Serializable]
    ...
    public class StartClass
    {
        public static int StartMethod(string settingsFile)
        {
            ...
            var dllPathToload = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)!, "PresentationSourceInConsoleAppOne.Core.dll");
        ...
        static int GetPresentationSourceCount()
        {
        ...
        public bool RunInCurrentAppDomain(TransientSettingsData settingsData)
        {
            ...
            LogHelper.WriteLine($"Process id: {process.Id}");
            ...
            LogHelper.WriteLine($"PresentationSourceCount: {presentationSourceCount}");
            ...
            try
            {
                ...
                //    // your code
                //    LogHelper.WriteLine($"Before creating instance");
                //    var window = instanceCreator();
                //    LogHelper.WriteLine($"After creating instance");
                //});

                LogHelper.WriteLine($"Preparing to inject ...");
            ...
            catch (Exception exception)
            {
                ...
                LogHelper.WriteLine($"Exception: {exception.GetType().Name}, message: {exception.Message}");
            ...
            Func<TransientSettingsData, DispatcherRootObjectPair, SnoopMainBaseWindow> instanceCreator)
        {
            ...
            {
                LogHelper.WriteLine($"DispatcherRootObjectPairs count is: {dispatcherRootObjectPairs.Count}");
                LogHelper.WriteLine($"Returning false: ");
                return false;
            }
