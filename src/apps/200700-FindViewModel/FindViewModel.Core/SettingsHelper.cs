...
#pragma warning disable SA1310
        ...
        public const string SNOOP_SETTINGS_DIRECTORY_NAME = ".FindViewModel";
...
#pragma warning restore SA1310
        ...
        public static string GetSettingsFileForFindViewModel()
        {
            var file = "FindViewModelSettings.xml";
        ...
        public static IEnumerable<string> GetPotentialSettingsPaths()
        {
            ...
            // 4. AppData
            {
                var path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "FindViewModel");
