namespace FindViewModel.InjectorLauncher;
...
public static class Injector
{
    public static void LogMessage(string message, bool append = true)
    {
        ...
        var pathname = Path.Combine(applicationDataPath, "FindViewModelLog.txt");
    ...
    private static void StartFindViewModel(ProcessWrapper processWrapper, InjectorData injectorData)
    {
        var injectorDllName = $"FindViewModel.CppInjectorCore.{processWrapper.Architecture}.dll";
